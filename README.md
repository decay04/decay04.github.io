# decay04.github.io
## CИСТЕМЫ ЛОЯЛЬНОСТИ ##
Проект исследует колониальный характер отношений между рф и странами постсоветского пространства, на примере формирования сетей военной логистики полномасштабного вторжения рф в Украину (2022 г)
